...
SERVER = 'sameenjalal.com'
PORT = 8080

# fake urls for the test server (matches ones in server.py)
REQUEST_TOKEN_URL = 'https://api.twitter.com/oauth/request_token'
ACCESS_TOKEN_URL = 'https://api.twitter.com/oauth/authorize'
AUTHORIZATION_URL = 'https://api.twitter.com/oauth/access_token'
CALLBACK_URL = 'None'
#RESOURCE_URL = 'http://photos.example.net/photos'

# key and secret granted by the service provider for this consumer application - same as the MockOAuthDataStore
CONSUMER_KEY = 'dkUy68p1tTXkeqcP3Lrwg'
CONSUMER_SECRET = 'DjaduDFzghGFM4Vf27iCa0BsdsWPbQgjbTA1ld7J04'
